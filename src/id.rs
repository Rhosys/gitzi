...
const WORDS: &[&str; 256] = &[
    "ace", "arc", "ash", "axe", "bay", "bee", "bit", "bow", "box", "bud", "bus", "cap", "car",
    "cat", "cob", "cod", "cog", "cow", "cub", "cup", "cut", "dam", "dew", "dig", "dim", "dot",
    "dug", "dye", "ear", "eel", "egg", "elk", "elm", "emu", "eye", "fan", "far", "fig", "fin",
    "fir", "fit", "fix", "fly", "fog", "fox", "fur", "gap", "gas", "gem", "gin", "gum", "gut",
    "gym", "hat", "hay", "hen", "hex", "hip", "hog", "hop", "hot", "hub", "hue", "hum", "ice",
    "imp", "ink", "inn", "ion", "ire", "ivy", "jab", "jam", "jar", "jaw", "jay", "jet", "jig",
    "jog", "jot", "joy", "jug", "key", "kid", "kit", "lab", "lag", "lap", "law", "lay", "leg",
    "let", "lid", "lip", "lit", "log", "lot", "low", "lug", "map", "mat", "maw", "mix", "mob",
    "mod", "mop", "mud", "mug", "nap", "net", "nib", "nod", "nor", "not", "now", "nut", "oak",
    "oar", "oat", "odd", "ode", "oil", "old", "one", "orb", "ore", "our", "out", "owl", "own",
    "pad", "pan", "paw", "pea", "peg", "pen", "pet", "pie", "pig", "pin", "pit", "ply", "pod",
    "pop", "pot", "pub", "pug", "pun", "put", "rag", "ram", "ran", "rap", "rat", "raw", "ray",
    "red", "rib", "rid", "rig", "rim", "rip", "rod", "roe", "rot", "row", "rub", "rug", "rum",
    "run", "rut", "rye", "sap", "saw", "sea", "set", "shy", "sip", "sit", "six", "ski", "sky",
    "sly", "sob", "sod", "son", "sow", "spa", "spy", "sum", "sun", "tab", "tag", "tan", "tap",
    "tar", "tax", "tea", "ten", "the", "tie", "tin", "tip", "toe", "ton", "top", "tow", "toy",
    "try", "tub", "tug", "two", "urn", "van", "vat", "vet", "vim", "vow", "wag", "war", "wax",
    "way", "web", "wet", "wig", "win", "wit", "woe", "wok", "won", "yak", "yam", "yap", "yaw",
    "yew", "yip", "zap", "zen", "zig", "zip", "zoo", "arm", "art", "bag", "ban", "bar", "bat",
    "bed", "big", "bin", "bog", "bot", "bow", "bug", "bun", "but",
];
