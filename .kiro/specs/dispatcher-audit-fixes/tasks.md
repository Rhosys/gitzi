...
- [x] 2. Implement review item persistence layer
  ...
  - [x] 2.3 Write property test for review item round-trip (Property 1)
  ...
  - [x] 2.4 Write property test for action append persistence (Property 2)
...
- [x] 3. Implement ID module and config changes
  ...
  - [x] 3.2 Write property test for ID format invariant (Property 3)
  ...
  - [x] 3.3 Write property test for slug determinism (Property 4)
  ...
  - [x] 3.4 Write property test for old/new ID acceptance (Property 5)
  ...
  - [x] 3.5 Write property test for config role validation (Property 11)
...
- [x] 4. Checkpoint - Verify foundational changes compile
  - Ensure all tests pass, ask the user if questions arise.

- [x] 5. Modify task model and dispatcher WIP logic
  ...
  - [x] 5.2 Add WIP waiting map to Dispatcher in `src/dispatcher/mod.rs`
  ...
  - [x] 5.3 Fix double-signal on approval/rejection in `src/dispatcher/mod.rs`
  ...
  - [x] 5.4 Persist review items on buffer entry in `src/dispatcher/mod.rs`
  ...
  - [x] 5.5 Persist task files on approve/reject in `src/dispatcher/mod.rs`
  ...
  - [x] 5.6 Write property test for WIP limit blocking (Property 8)
  ...
  - [x] 5.7 Write property test for WIP release re-signal (Property 9)
...
- [x] 6. Implement agent loop changes
  - [x] 6.1 Implement TropeBlocker retry logic in `src/dispatcher/agent_pool.rs`
  ...
  - [x] 6.2 Implement WIP gate in `try_advance()` within `src/dispatcher/agent_pool.rs`
  ...
  - [x] 6.3 Implement `AgentResult::Blocked` handling in agent loop
  ...
  - [x] 6.4 Fix `build_run_context()` to use session state repo path
  ...
  - [x] 6.5 Fix `resume_context()` git2 0.21 `commit.summary()` API
  ...
  - [x] 6.6 Write property test for max one retry (Property 6)
  ...
  - [x] 6.7 Write property test for event ordering (Property 7)
  ...
  - [x] 6.8 Write property test for AgentBlocked flow (Property 10)
  ...
  - [x] 6.9 Write property test for RunContext repo_root (Property 14)
...
- [x] 7. Checkpoint - Verify agent loop changes compile and pass
  - Ensure all tests pass, ask the user if questions arise.

- [x] 8. Daemon and boot changes
  - [x] 8.1 Add `Environment=HOME=...` to systemd unit in `src/daemon/mod.rs`
  ...
  - [x] 8.2 Load unresolved review items on boot in `Dispatcher::start()`
  ...
  - [x] 8.3 Write property test for DispatchEvent JSON round-trip (Property 13)
